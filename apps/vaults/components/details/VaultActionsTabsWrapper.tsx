...
import VaultDetailsQuickActionsFromOrca from '@vaults/components/details/actions/QuickActionsFromOrca';
...
const tabs: TTabsOptions[] = [
	...
	{value: 1, label: 'Redeem', flowAction: Flow.Withdraw, slug: 'withdraw'},
...
function VaultActionsTabsWrapper({currentVault,amount1,amount2,amount3,amount4,userInput1,userInput2,setUserInput1,setUserInput2,button_message,button_is_clicked,is_busy,other_token_name}: {currentVault: TYDaemonVault,amount1:any,amount2:any,amount3:any,amount4:any,userInput1:any,userInput2:any,setUserInput1:any,setUserInput2:any,button_message:any,button_is_clicked:any,is_busy:any,other_token_name:any}): ReactElement {
	...
	let vault_type="Whirlpool"
	console.log(currentVault)
	if (currentVault["ftr_type"]=="Distributor"){
		vault_type="Distributor"
		...
		<>
			...
			<div aria-label={'Vault Actions'} className={'col-span-12 mb-4 flex flex-col bg-neutral-100'}>
				...
				{currentTab.value === 3 ? (
					...
					{vault_type === "Whirlpool" ? (
						<VaultDetailsQuickActionsFromOrca amount1={amount1} amount2={amount3} amount3={amount3} amount4={amount4} userInput1={userInput1} setUserInput1={setUserInput1} other_token_name={other_token_name}/>
						...
						<div className={'w-full space-y-0 md:w-42 md:min-w-42 md:space-y-2'}>
							...
							<div>
								<VaultDetailsQuickActionsButtons button_message={button_message} button_is_clicked={button_is_clicked} is_busy={is_busy} />
							</div>
