...
function VaultDetailsHistoricalFTR({currentVault, harvestData}: {currentVault: TYDaemonVault, harvestData: TGraphData[]}): ReactElement {
...
export {VaultDetailsHistoricalFTR};
